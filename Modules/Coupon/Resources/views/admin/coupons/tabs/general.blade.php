<div class="row">
    <div class="col-md-8">
        ...
        {{ Form::select('is_percent', trans('coupon::attributes.is_percent'), $errors, [0=>'Sabit' , 1 => 'Yüzde'], $coupon) }}
        ...
        {{ Form::text('start_date', 'Başlangıç Tarihi', $errors, $coupon, ['class' => 'datetime-picker', 'data-default-date' => $coupon->start_date]) }}
        {{ Form::text('end_date', 'Bitiş Tarihi', $errors, $coupon, ['class' => 'datetime-picker', 'data-default-date' => $coupon->end_date]) }}
