...
class Order extends Model
{
    ...
    {
        return ShippingCompany::find($shippingMethod)->name ?? null;
    }
    ...
    public function storeProductsForApi($cartItem)
    {
        $orderProduct = $this->products()->create([
            'product_id' => $cartItem->product->id,
            'unit_price' => $cartItem->totalPriceNotFormatted,
            'qty' => $cartItem->quantity,
            'line_total' => $cartItem->totalPriceNotFormatted,
        ]);

        $orderProduct->storeOptionsForApi(json_decode($cartItem->options));
    }
