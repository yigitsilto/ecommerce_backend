            ...
            <div class="order clearfix">
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        @if ($order->cargo_no)
                            <tr>
                                <td>{{ 'Kargo Anahtarı' }}</td>
                                <td>{{ $order->cargo_key }}</td>
                            </tr>
                        @endif

                        @if ($order->cargo_status)
                            <tr>
                                <td>{{ 'Kargo Durumu' }}</td>
                                <td>

                                    @if($order->cargo_status == "NOP")
                                        Henüz işleme alınmadı

                                    @elseif($order->cargo_status == "IND")

                                        Kargoya Verildi

                                    @elseif($order->cargo_status == "DLV")
