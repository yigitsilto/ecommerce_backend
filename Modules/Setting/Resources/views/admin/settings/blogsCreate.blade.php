        ...
        <div class="box-body clearfix">
            ...
            <div class="col-lg-12 col-md-12">
                <div class="tab-wrapper category-details-tab">
                    ...
                    <form method="POST" action="{{ route('admin.blogs.store') }}" class="form-horizontal" id="product-create-form" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="tab-content">
                            <div id="general-information" class="tab-pane fade in active">
                                ...
                                {{ Form::text('short_description', 'Kısa Açıklama', $errors, 'short_description', ['labelCol' => 2, 'required' => true]) }}


                                {{ Form::wysiwyg('description', 'Açıklama', $errors, 'description', ['labelCol' => 2, 'required' => true]) }}

                                {{ Form::file('cover_image', 'Kapak Resmi', $errors, 'image', ['labelCol' => 2, 'required' => true]) }}
