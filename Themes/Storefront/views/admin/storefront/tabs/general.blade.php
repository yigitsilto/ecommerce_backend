<div class="row">
    <div class="col-md-8">
        ...
        {{ Form::select('storefront_theme_color', 'Birincil Renk', $errors, trans('storefront::themes'), $settings) }}
        ...
        {{ Form::select('storefront_mail_theme_color', 'İkincil Renk', $errors, trans('storefront::themes'), $settings) }}
